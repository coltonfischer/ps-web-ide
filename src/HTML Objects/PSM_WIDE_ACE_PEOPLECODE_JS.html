    ...
    this.$rules = {
      ...
      "#classes": [{
        ...
        push: [{
          ...
          token: ["storage.modifier.pcode", "meta.method.identifier.pcode", "entity.name.function.pcode"],
          regex: /(class)(\s+)([\w]+)$/,
          caseInsensitive: true,
          push: [{
      ...
      "#functions": [{
        ...
        push: [{
          ...
          token: ["storage.modifier.pcode", "meta.Function.identifier.pcode", "entity.name.function.pcode", "meta.Function.identifier.pcode", "meta.Function.identifier.pcode"],
          regex: /(Function)(\s+)([\w]+)(\(.*\))(.*)/,
          caseInsensitive: true,
          push: [{
      ...
      "#object-types": [{
        ...
        token: ["storage.type.pcode", "keyword.operator.dereference.pcode", "storage.type.pcode"],
